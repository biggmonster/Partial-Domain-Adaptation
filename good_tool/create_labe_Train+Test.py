...
#----------------------------LongSig_50------------------------------------------------------------------- 
    ...
    target_output_dir_train = r"D:\LJ\workstation\Vscode\New_ISRA\data\LongSig_50\Target\Train\Train1_Test9"         # 标签文件存放的路径
    target_output_dir_test = r"D:\LJ\workstation\Vscode\New_ISRA\data\LongSig_50\Target\Test\Train1_Test9"    
